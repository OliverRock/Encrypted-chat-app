...
/**
 * Class contains a panel to display a the login screen
 * 
 * @author oliverrock
 *
 */
...
public class GuiSignin extends JPanel {
	...
	public GuiSignin() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (username.equals("") || password.equals("")) {
					JOptionPane.showMessageDialog(ChatClientApp.frame, "Both username and password can not be empty!",
				...
				if (response[1].equals("true")) {
					...
					ChatClientApp.frame.setContentPane(ChatClientApp.frame.guiChatroom);
					ChatClientApp.frame.setTitle("Chat Room");
					ChatClientApp.frame.guiChatroom.StartCheckingMessages();
				} else {
					JOptionPane.showMessageDialog(ChatClientApp.frame, response[2], "Sign-in Error",
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ChatClientApp.frame.setContentPane(ChatClientApp.frame.guiSignUp);
