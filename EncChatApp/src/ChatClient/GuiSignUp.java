...
/**
 * Class contains a panel to display the registration screen.
 * 
 * @author oliverrock
 *
 */
	...
	public GuiSignUp() {
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(ChatClientApp.frame, response[2], "Message from server",
						JOptionPane.INFORMATION_MESSAGE);
				if (response[1].equals("true")) {
					ChatClientApp.frame.setContentPane(ChatClientApp.frame.guiSignin);
